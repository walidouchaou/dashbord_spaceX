		...
		.columns([
			...
			},
			{
				...
				format: (d) => {
                  ...
                  <img data-src="src/img/youtube_social_red.png" class="link-icon-small lazyload"
...
const getNextLaunchRocketImage = (rocket_name) => {
	...
	switch (rocket_name) {
		case 'Used Falcon 9' || 'Used Falcon 9':
			nextLaunchRocketImage = 'src/img/falcon9.png';
			break;
		case 'Falcon Heavy':
			nextLaunchRocketImage = 'src/img/falcon-heavy.png';
			break;
		case 'Starship':
			nextLaunchRocketImage = 'src/img/starship.png';
			break;
		default:
			nextLaunchRocketImage = 'src/img/falcon9.png';
			break;
